...
class ResultadoFeriadoPorFiltro : AppCompatActivity(), ApiCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        filtroDialog.setDialogCallback(object : FiltroDialog.DialogCallback {
            override fun onOptionSelected(selectedOption: String) {
                ...
                val apiRequestTask = ApiTask(this@ResultadoFeriadoPorFiltro)
    ...
    {
        feriadosLV = findViewById(R.id.holidayLV)
